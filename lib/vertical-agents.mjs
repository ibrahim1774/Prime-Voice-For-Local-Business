  ...
  const assistant = {
    ...
    startSpeakingPlan: {
      ...
      transcriptionEndpointingPlan: {
        ...
        // Raised back from 0.3 now that smartFormat means this path fires
        // only on real ambiguity — a caller mid-list ("a couch… a mattress…")
        // rather than every second sentence. Cutting people off there is a
        // worse failure than a short wait, and re-asking for a half-heard
        // item list costs far more than 0.15s.
